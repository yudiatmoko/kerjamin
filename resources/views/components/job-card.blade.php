    ...
    <div class="flex flex-col h-full">
        ...
        <div class="mt-auto flex flex-col md:flex-row md:justify-between md:items-center gap-6">
            ...
            <div class="w-full md:w-auto text-center md:text-right">
                <span class="w-full md:w-auto inline-block bg-primary text-white text-base font-semibold px-6 py-3 rounded-xl group-hover:bg-opacity-90 transition-colors duration-300">
                    Detail
                </span>
            </div>
        </div>
